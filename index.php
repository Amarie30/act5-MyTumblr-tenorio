...
$acc_username = "AnnaMarie";
$acc_password = "annamarie";
$acc_fullname = "Anna Marie Tenorio";
$acc_address = "Philippines";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		if(isset($_REQUEST['notexist']) === true){
		      				echo "<div class='alert alert-warning' role='alert'>Username does not exist... </div>";
								...
								echo "<div class='alert alert-info' role='alert'>Successfully Logout.. </div>";

							}else if (isset($_REQUEST['logfirst'])===true){
								echo "<div class='alert alert-warning' role='alert'>Please log in first... </div>";
