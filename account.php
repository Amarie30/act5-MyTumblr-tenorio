...
body {
    background: #654ea3;
    background: linear-gradient(to bottom right, #cc0066 0%, #9999ff 50%);
    min-height: 100vh;
    overflow-x: hidden
}</style>
                                </head>
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="py-4 px-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-2 pl-lg-1"><img src="images/img.jpg" alt="" class="img-fluid rounded shadow-sm"></div>                
                    <div class="col-lg-6 pr-lg-1 mb-2"><img src="images/image.jpg" alt="" class="img-fluid rounded shadow-sm"></div>
